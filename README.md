...
1. Accessing basefile folder, perform bellow opration
    ...
    1.1 install MGLTools program, which is available http://mgltools.scripps.edu/downloads 
      ...
      3.1.2 accessing /mgltools_x86_64Linux2_1.5.6/MGLToolsPckgs/AutoDockTools/Utilities24, copy 'prepare_ligand4.py' and 'prepare_receptor4.py' to basefile folder
